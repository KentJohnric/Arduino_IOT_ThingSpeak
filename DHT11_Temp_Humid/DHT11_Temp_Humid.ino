...
String apiKey = "5XCFUMMP1MX2DHRC";     // replace with your channel's thingspeak WRITE API key

String ssid="MortyMcFly2020!";    // Wifi network SSID
String password ="Valorant2020!";  // Wifi network password
